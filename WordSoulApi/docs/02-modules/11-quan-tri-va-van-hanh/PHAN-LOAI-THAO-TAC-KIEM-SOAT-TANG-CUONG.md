...
| M11-EC-F01 | Schedule/execution API và runtime enhanced-control context | Immutable request + single-actor decision đã chốt; protected refs, server-derived actor/resource | M11-T010–T011; M11-T049 |
