...
|---|---|---|---|
| M11-GRANT-F01 | Source/code verification không có temporary/emergency/bypass path | Contract cấm; fixed R13 continuity only | M11-T006-A; A-G02 |
| M11-GRANT-F02 | Sensitive action classification/change request/rollback | Current re-auth/reason/audit/idempotency obligations giữ nguyên | M11-T007–T011 |
