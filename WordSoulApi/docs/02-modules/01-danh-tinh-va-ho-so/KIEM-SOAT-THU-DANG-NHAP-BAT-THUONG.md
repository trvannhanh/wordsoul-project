...
|---|---|---|---|
| M01-ABUSE-F01 | Recovery proof phía sau risk action ticket | Ticket/state/session interaction đã chốt ở M01-INACTIVE-1.0/M01-SESSION-1.0; recovery không hạ chuẩn | M01-T019 |
