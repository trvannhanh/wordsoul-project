...
- Chín finding triển khai và một finding mở có baseline an toàn cùng task/module tiếp nhận; M01-LOGIN-F01 đã đóng bằng M01-ABUSE-1.0/M12-RATE-1.0/M12-FAIL-1.0, M01-LOGIN-F02 bằng M01-RECOVERY-1.0 và M01-LOGIN-F03 bằng M01-SESSION-1.0.
