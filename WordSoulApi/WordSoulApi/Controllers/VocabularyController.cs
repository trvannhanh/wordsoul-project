...
namespace WordSoulApi.Controllers
{
    ...
    public class VocabularyController : ControllerBase
    {
        ...
        public VocabularyController(IVocabularyService vocabularyService, IUploadAssetsService uploadAssetsService, ILogger<VocabularyController> logger, ISetVocabularyService setVocabularyService)
        {
        ...
        public async Task<IActionResult> AddVocabularyToSet(int setId, [FromForm] CreateVocabularyInSetDto vocabularyDto)
        {
            ...
            try
            {
                ...
                var createdVocabulary = await _setVocabularyService.AddVocabularyToSetAsync(setId, vocabularyDto, imageUrl);
        ...
        public async Task<IActionResult> GetVocabulariesInSet(int setId, int pageNumber = 1, int pageSize = 10)
        {
            ...
            var result = await _setVocabularyService.GetVocabulariesInSetAsync(setId, pageNumber, pageSize);
        ...
        {
            var result = await _setVocabularyService.RemoveVocabularyFromSetAsync(setId, vocabId);
