...
* **Styling Policy:** Use Tailwind CSS (v3/v4) for 90% of styling.
    ...
    * **VOCAMON PROJECT OVERRIDE [CRITICAL]:** This project specifically uses **React + Vite + TypeScript**. Ensure all components follow the `.tsx` extension and strict typing.
...
* **VOCAMON AESTHETICS:** Vocamon follows a **High-End Dark Mode** by default. Use `bg-[#0f172a]` (Slate-900) as the base, with `glassmorphism` panels (`backdrop-blur-xl bg-white/5 border border-white/10`).
