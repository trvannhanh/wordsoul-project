...
- **VOCAMON SPECIFIC:** Developing in **.NET** using **Clean Architecture** and **MediatR**.
...
### 1. Route & Controller Definition (Vocamon .NET)
...
public class VocabularyController : ControllerBase
{
    ...
    public VocabularyController(IMediator mediator) => _mediator = mediator;
...
Always validate in the **Application Layer** using FluentValidation:
