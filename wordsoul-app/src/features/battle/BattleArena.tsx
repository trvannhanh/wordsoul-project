...
export default function BattleArena() {
    ...
    if (state.phase === 'connecting') {
        return (
            <div className="h-screen w-full overflow-hidden flex items-center justify-center" style={{ background: 'rgb(2,6,23)' }}>
                <div className="text-center">
                    <div className="text-yellow-400 text-5xl mb-4 animate-[vsFlash_1s_ease-in-out_infinite]">⚔️</div>
                    <p className="font-press text-sm text-white animate-pulse">CONNECTING TO BATTLE...</p>
                </div>
            </div>
        );
    }
    ...
    return (
        <div
            ...
            style={{ background: 'linear-gradient(180deg, rgb(2,6,23) 0%, rgb(6,2,20) 100%)' }}
        >
            {/* Battle Intro */}
            {showIntro && (
                <BattleIntroOverlay
            ...
            <div className="absolute z-30 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-2xl px-4 flex flex-col drop-shadow-2xl">
                <div className="bg-black/60 backdrop-blur-sm p-4 rounded-xl border border-gray-700/50">
                    {/* Score/timer row */}
                    {q && (
                        <div className="flex items-center gap-4 mb-3">
                            ...
                            <div
                                className={`
                shrink-0 px-2 py-1 rounded border font-pixel text-[9px]
                ${(q.roundIndex ?? 0) >= 9
              ...
              `}
                    ...
                    {q ? (
                        <div
                            className="rounded border-2 border-gray-600 bg-[#0a0a1e] p-4 mb-3"
                            style={{ boxShadow: '3px 3px 0 #00000066' }}
                        >
                        ...
                        <div
                            className="rounded border-2 border-gray-700 bg-[#0a0a1e] p-4 mb-3 flex items-center justify-center min-h-[80px]"
                        >
                            <span className="font-pixel text-xs text-gray-600 animate-pulse">
                            ...
                            {q.options.map((opt, i) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`
                    relative p-3 rounded border-2 text-left
                    font-noto text-xs sm:text-sm
                  ...
                  `}
                                    ...
                                    >
                                        <span
                                            className={`
                      inline-block w-5 h-5 rounded text-center mr-2
                      font-pixel text-[9px] leading-5
