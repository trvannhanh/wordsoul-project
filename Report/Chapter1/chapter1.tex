...
\textbf{Chương 2 — Cơ sở lý thuyết} tổng hợp và phân tích hệ thống nền tảng khoa học. Nội dung trọn tâm bao gồm cơ chế ghi nhớ lâu dài qua đường cong Ebbinghaus, mô hình toán học của thuật toán lặp lại ngắt quãng SM-2, các nguyên lý thiết kế Gamification hiệu quả dựa trên Thuyết Tự Quyết (SDT), và khảo sát các giải pháp liên quan hiện có trên thị trường.
