...
(1) Hiện thực hóa quy trình ghi nhớ dựa trên thuật toán SM-2 tiêu chuẩn, bổ sung hàm chấm điểm đa yếu tố tự động để thay thế bước tự đánh giá thủ công trong SM-2 gốc bằng tính toán dựa trên độ chính xác, tốc độ phản hồi và số gợi ý sử dụng; 
...
Cần lưu ý rằng hệ thống bao gồm nhiều tính năng (thú ảo, PvP/PvE, nhiệm vụ, thành tích, quản trị) vì các tính năng này được thiết kế như một hệ thống Gamification tích hợp, trong đó đóng góp kỹ thuật cốt lõi là hiện thực hóa thuật toán SM-2 và cơ chế ghi nhớ đa dạng; các tính năng Gamification đóng vai trò là phương tiện duy trì động lực học tập, không phải là mục tiêu nghiên cứu độc lập. Ngoài phạm vi trên, đề tài không bao gồm việc giảng dạy ngữ pháp chuyên sâu, luyện tập phát âm qua công nghệ nhận diện giọng nói, hay xây dựng các tính năng giao tiếp hội thoại tự do. Tương tác thời gian thực trong hệ thống được giới hạn trong phạm vi các phiên đối kháng trắc nghiệm có cấu trúc, không mở rộng sang các hình thức giao tiếp ngôn ngữ ngữ cảnh mở. Nhờ đó, nguồn lực được tập trung vào quy trình học tập và quản lý từ vựng.
